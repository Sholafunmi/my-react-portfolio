...
const Hero = () => {
  return (
    <div name='hero' className='w-full h-screen sm:mw-fit lg:h-screen bg-[#0a192f] flex justify-center items-center'>

    {/* container  */}
        <div className='max-w-[1000px]  px-8 mt-32 flex flex-col justify-center h-full '>
            <p className='text-[#8892b0]  '>Hi, Nice to meet you!</p>
            <p className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>My name is Sholafunmi Adewara</p>
